...
{
//printf("daiting add rule before syscall: %08x\n", sp);
//ALOGE("*********************daiting before ioctl \n");
//ALOGE("*********************daiting before ioctl macro: %08x \n", IOCTL_ADD_RULE);
//ALOGE("*********************daiting before ioctl com: %08x \n", _IOR(MAJOR_NUM, 3, struct sec_policy *));
//ALOGE("*********************daiting before ioctl com: %08x, %08x, %08x\n", MAJOR_NUM, 3, sizeof(struct sec_policy *));
  ioctl(file_desc, IOCTL_ADD_RULE, sp);
//ALOGE("*********************daiting after ioctl \n");
}
