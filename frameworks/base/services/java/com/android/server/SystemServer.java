...
//@xiaolei 
//import swl.monitor.MonitorManagerService;
import com.android.server.MonitorManagerService;
//#xiaolei
...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        try {
		 ...
		 //@ xiaolei : add monitor service
	    Slog.i(TAG, "daiting Monitor Manager.");
	    ServiceManager.addService("monitor", new MonitorManagerService(context));
	    //# xiaolei
