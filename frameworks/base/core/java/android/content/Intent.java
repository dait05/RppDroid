...
//added by daiting
	public void mysetPname(String myPname)
	{
		this.myPname = myPname;
	}
	public String mygetPname()
	{
		return myPname;
	}
	...
	//added by daiting (maybe wrong, the last field of intent)
	out.writeString(myPname);
    }
