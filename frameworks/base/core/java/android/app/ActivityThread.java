...
//added by daiting
 final ArrayMap<IBinder, ActivityClientRecord> myhActivities
            = new ArrayMap<IBinder, ActivityClientRecord>();
...
//added by daiting
System.out.println("Hooked by daiting sla1: " + intent.mygetPname());
...
//added by daiting
myhActivities.put(r.token, r);
System.err.println("daiting hactivity: "+r.token);
//
...
//added by daiting, this part is after OnCreate() of the activity...
		System.err.println("daiting mactivity: "+r.token);
myhActivities.clear();//wrong
//
...
//added by daiting
//System.out.println("Hooked by daiting hla: " + r.intent.mygetPname());
