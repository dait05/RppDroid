...
public class MediaRecorder
{
	...
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(mm.getCurrentPid()), "MediaRecorder.MediaRecorder", mm.Args() )!=0)
	{
		mEventHandler = null;
		//return;
	}
    ...
    //@xiaolei
    //orig: public native void start() throws IllegalStateException;
    public void start() throws IllegalStateException {
    	MonitorManager mm = MonitorManager.getDefault();
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(mm.getCurrentPid()), "MediaRecorder.start", mm.Args() )!=0)
	{
		return;
	}
        start_mod();
    }
    private native void start_mod() throws IllegalStateException;
    //#xiaolei
     ...
     */
    //orig: public native void stop() throws IllegalStateException;
    ...
    private native void stop_mod() throws IllegalStateException;
    //#xiaolei
