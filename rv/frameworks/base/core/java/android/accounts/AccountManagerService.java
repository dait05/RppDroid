...
public class AccountManagerService
	...
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(getCallingPid()), "AccountManagerService.getAuthenticatorTypes", mm.Args() )!=0)
	{
	...
	//@monitor by xiaolei
	MonitorManager mm = MonitorManager.getDefault();
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(getCallingPid()), "AccountManagerService.getAccountsByType", mm.Args(accountType) )!=0)
	{
	...
	//@monitor by xiaolei
	MonitorManager mm = MonitorManager.getDefault();
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(getCallingPid()), "AccountManagerService.getAccounts", mm.Args() )!=0)
	{
		return new Account[0];
	}
	//#end by xiaolei
