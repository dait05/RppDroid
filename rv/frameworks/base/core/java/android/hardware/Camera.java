...
public class Camera {
	...
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(mm.getCurrentPid()), "Camera.Camera", mm.Args() )!=0)
	{
		mEventHandler = null;
		//return;
	}
	...
	//@monitor by xiaolei
	MonitorManager mm = MonitorManager.getDefault();
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(mm.getCurrentPid()), "Camera.setPreviewDisplay", mm.Args(holder) )!=0)
		return;
	//#end by xiaolei
        if (holder != null) {
