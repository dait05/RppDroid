...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
    ...
    //@xiaolei: mSource--> (e.g. App1 issue intent to system, system issue another intent for App1)
    // created for ResolverActivity to figure out who is App1 instead of only AMS (ActivityManagerService)
    private String mDelegationSource = "UnZone";
    //#xiaolei
	...
	//@xiaolei
	this.mDelegationSource = o.mDelegationSource;
	//#xiaolei
    ...
    //@xiaolei
    public String getDelegationSource() {
	return mDelegationSource;
    }
    //#xiaolei
	...
	//@xiaolei
	public Intent setDelegationSource(String ds) {
		mDelegationSource = ds;
		return this;
	}
	//#xiaolei
	...
	//@xiaolei
	out.writeString(mDelegationSource);
	//#xiaolei
	...
	//@xiaolei
	mDelegationSource = in.readString();
	//#xiaolei
