...
class ZygoteConnection {
    ...
    boolean runOnce() throws ZygoteInit.MethodAndArgsCaller {
		...
		//@xiaolei baigd
		//Log.e("ZygoteConnection", "parsedArgs.niceName " + parsedArgs.niceName);
		if (parsedArgs.niceName != null)
		{
			Log.e("ZygoteConnection", parsedArgs.niceName + " " + pid);
			//parsedArgs.niceName.equals("com.android.testproject")
			try{
				Zygote.etrace(parsedArgs.niceName.getBytes("US-ASCII"),pid);
			}catch(java.io.UnsupportedEncodingException e){
				e.printStackTrace();
			}
		//	java.lang.Process ls_proc =  java.lang.Runtime.getRuntime().exec("/system/xbin/etrace-bin -f /etc/mapfile.alc -p " + pid);
			//Log.e("ZygoteConnection", "com.android.testproject is forked " + pid);
			//try {
				//Log.e("Create new alcatraz process for ", "etrace-bin -f /etc/mapfile.alc -p " + pid);
				//Zygote.etrace("home".toCharArray(),pid);
				//java.lang.Process ls_proc0 =  java.lang.Runtime.getRuntime().exec("/system/xbin/tcpdump");
 		                //java.lang.Process ls_proc =  java.lang.Runtime.getRuntime().exec("/system/xbin/etrace-bin -f /etc/mapfile.alc -p " + pid);
				//java.lang.Process ls_proc1 =  java.lang.Runtime.getRuntime().exec("/system/xbin/tcpdump");
        	          /*} catch (IOException e) {
                		e.printStackTrace();
 	                 } catch (Exception e){
				e.printStackTrace();
	...
	//#xiaolei
	    ...
	    //@xiaolei don't interfere remainingArgs
	    curArg = 0;
	    for ( /* curArg */ ; curArg < remainingArgs.length; curArg++) 
	    {
		String arg = remainingArgs[curArg];
