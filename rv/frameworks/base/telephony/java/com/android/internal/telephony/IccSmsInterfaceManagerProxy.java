...
public class IccSmsInterfaceManagerProxy extends ISms.Stub {
	...
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(getCallingPid()), "IccSmsInterfaceManagerProxy.sendData", mm.Args() )!=0)
	{
		return;
	}
	//# end by xiaolei
	...
	//@ xiaolei
	MonitorManager mm = MonitorManager.getDefault();
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(getCallingPid()), "IccSmsInterfaceManagerProxy.sendText", mm.Args() )!=0)
	{
		return;
	}
	//# end by xiaolei
	...
	//@ xiaolei
	MonitorManager mm = MonitorManager.getDefault();
	if(mm.Hook(mm.getPackageNameForMonitoredProcess(getCallingPid()), "IccSmsInterfaceManagerProxy.sendMultipartText", mm.Args() )!=0)
	{
		return;
	}
	//# end by xiaolei
